...
<html>
  <head>
    ...
    <!-- Bootstrap -->
    <link href="${appRootPath}/statics/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- styles -->
    <link href="${appRootPath}/statics/css/styles.css" rel="stylesheet">
  ...
  <body>
    ...
    <script src="${appRootPath}/statics/js/component/custom.js"></script>
  </body>
</html>